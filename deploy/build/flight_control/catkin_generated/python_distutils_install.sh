...
echo_and_run cd "/home/zxh/ws/wrqws/quaddif/deploy/src/flight_control"
...
echo_and_run /usr/bin/env \
    ...
    "/home/zxh/ws/wrqws/quaddif/deploy/src/flight_control/setup.py" \
     \
    build --build-base "/home/zxh/ws/wrqws/quaddif/deploy/build/flight_control" \
    install \
    --root="${DESTDIR-/}" \
